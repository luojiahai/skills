...
What's here right now: a Douyin account archiver.
...
Pick the skills you want and the agents to install them on, then type the skill's name — `/douyin-downloader`. None of these start on their own.
