...
**A new bucket, `media/`.** The set has been finance-only until now. This one keeps copies of things you'd otherwise lose, which is the same boring-admin itch from a different direction.
