...
| | |
|---|---|
| **Returns** | `../<name>/worksheet.md` · `../<name>/worksheet.md` |
| **Last updated** | <date> |
...
The property split follows the **legal ownership share on the title** and applies to rent and to every expense alike. It cannot be varied to put deductions with the higher earner.
...
| | <name> | <name> |
|---|---|---|
| Taxable income settled | | |
| Outstanding register empty | | |
| Every share above copied and matching | | |
| Bundle complete | | |

**Lodgeable: yes / no — <what is outstanding>**
