 ...
 * account. Nested per platform because the X platform writes this same file in this
 ...
 *
 * The same file, with the same number, is written by the X platform. The two platforms
 ...
 *
 * Schema 1 is the flat `douyin_<抖音号>` / `x_<handle>` layout, which has no root
