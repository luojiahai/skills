 ...
 * the X platform. Two platforms, two folders, so a sec_uid and an X user id cannot
 ...
 *
 * `id` is the sec_uid — the same key the X platform uses for the X user id, so both
